...
function results(){
  ...
  const learningReview=st.key==='SAP_Transformation'?`<details><summary>Best answer by round</summary><div class="detail-body">${renderBestAnswers()}</div></details>`:`${learningReview}`;
